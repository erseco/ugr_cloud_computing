...
\newcommand{\asunto}{Cloud Computing}
\newcommand{\titulo}{Servicio de	almacenamiento	en	
...
\newcommand{\profesor}{Manuel Parra}
...
\providecommand{\keywords}{cloud computing, openstack, docker, owncloud, nginx, postgresql, ldap}
...
\input{chapters/03_Conclusiones}
